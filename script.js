...
const eliminationRevealModal =
    document.getElementById("eliminationRevealModal");
...
const undercoverCountDisplay =
    document.getElementById("undercoverCountDisplay");

const whiteCountDisplay =
    document.getElementById("whiteCountDisplay");

const configurationMessage =
    document.getElementById("configurationMessage");
...
// ============================================
// MISTER WHITE NE PEUT PAS ETRE PREMIER
// ============================================
    ...
    if (!gameStarted) {
        ...
        if (
            ...
            instruction.textContent =
                "Tout le monde a consulté son information secrète. Vous pouvez maintenant commencer la partie.";
...
// ============================================
// CONTENU DE L'INFORMATION SECRETE
// IMPORTANT : AUCUN ROLE AFFICHE
// ============================================
...
function showRoleContent(player) {
    ...
    // IMPORTANT :
    // On remet toujours les textes à zéro
    // pour éviter qu'un ancien rôle reste affiché.
    ...
    roleDescription.textContent =
        "Mémorise cette information puis cache-la.";
    ...
    if (
        ...
        roleDescription.textContent =
            "Tu n'as aucun mot. Essaie de deviner le mot des autres joueurs.";
...
// ============================================
// REVELER L'INFORMATION
// ============================================

function openRole(player) {

    // Pendant la partie,
    // les cartes ne permettent plus
    // de révéler directement l'information.

    if (gameStarted) {

        alert(
            "Le jeu a commencé. Utilise « Revoir un profil » pour consulter une information."
        );
...
// ============================================
// REVELER LE ROLE DU JOUEUR ELIMINE
// ============================================

function showEliminatedPlayerRole(player) {
...
function newRound() {
    ...
    // Nouveaux rôles et mots

    assignRoles();


    // White ne peut pas être premier
